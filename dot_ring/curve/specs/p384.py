...
P384_RO = CurveVariant(
    name="P384_RO", curve=P384Curve(e2c_variant=E2C_Variant.SSWU), point=nu_variant(e2c_variant=E2C_Variant.SSWU)
)

P384_NU = CurveVariant(
    name="P384_NU", curve=P384Curve(e2c_variant=E2C_Variant.SSWU_NU), point=nu_variant(e2c_variant=E2C_Variant.SSWU_NU)
)
