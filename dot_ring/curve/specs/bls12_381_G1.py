...
def _descending_hex(*coefficients: str) -> tuple[int, ...]:
    return tuple(int(coefficient, 16) for coefficient in reversed(coefficients))


BLS12_381_G1_ISOGENY = RationalIsogeny[int](
...
BLS12_381_G1_PARAMS = ShortWeierstrassCurveParams[int](
    field_modulus=0x1A0111EA397FE69A4B1BA7B6434BACD7_64774B84F38512BF6730D2A0F6B0F624_1EABFFFEB153FFFFB9FEFFFFFFFFAAAB,
    subgroup_order=0x73EDA753299D7D483339D80809A1D805_53BDA402FFFE5BFEFFFFFFFF00000001,
    cofactor=0xD201000000010001,
    suite_id=b"BLS12381G1_XMD:SHA-256_SSWU_RO_",
    ...
    hash_to_curve=HashToCurveParams(
        ...
        field_length=64,
        expand_len=64,
        isogeny=BLS12_381_G1_ISOGENY,
    ),
    encoding=EncodingParams(endian="little", point_len=32, challenge_len=48),
)
