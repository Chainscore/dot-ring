...
class RingVrf:
    ...
    @staticmethod
    def generate_bls_signature(secret_t,producer_key, keys: List[Any]):
        """
    ...
    @staticmethod
    def ring_vrf_proof(alpha:bytes, add:bytes, blinding_factor:bytes, secret_key, producer_key:bytes, keys:List[Any] ):
