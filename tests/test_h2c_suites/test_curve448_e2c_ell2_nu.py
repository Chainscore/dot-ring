import os
from dot_ring.curve.specs.curve448 import nu_variant
from dot_ring.curve.e2c import E2C_Variant

Curve448Point = nu_variant(E2C_Variant.ELL2_NU)

def test_sswu_hash2_curve():
    import json
    base_dir = os.path.dirname(__file__)  # directory of current test file
    json_path = os.path.join(base_dir, "vectors", "curve448_nu.json")
    # Load JSON
    ...
    for i,t in enumerate(RFC_TEST_VECTORS, start=1):
        ...
        out = Curve448Point.encode_to_curve(msg_bytes, b"", True)
