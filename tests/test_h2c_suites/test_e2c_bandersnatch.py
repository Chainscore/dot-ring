...
def test_m2c():
    ...
    assert (
        p0.x
        == 45311200032263316917859627542467284358670199398458214934254495151428460867180
    )
    assert (
        p0.y
        == 12776320642587906524824617948027275973876805685686439823724827627303230293583
    )
    assert (
        p1.x
        == 4062918070531615925962241074596089620660059154890696073867928698119996156623
    )
    assert (
        p1.y
        == 28091649524129975855673249115644895380082395569265826631567705939331162643040
    )
...
def test_e2c():
    ...
    assert (
        u.x
        == 26037012954893424526367048031037997009889535281273781660989300420960588198291
    )
    assert (
        u.y
        == 2904166584983200306316763312322681981821413355244066354672834649878949825050
    )
