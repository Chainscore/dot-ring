...
def test_bench_ietf_prove():
    ...
    for index in range(len(data)):
        ...
        with Profiler(
            f"ietf_prove_sample_{index + 1}", save_stats=True, print_stats=True, sort_by="cumulative", limit=40
        ):
...
def test_bench_ietf_verify():
    ...
    for index in range(len(data)):
        ...
        with Profiler(
            f"ietf_verify_sample_{index + 1}", save_stats=True, print_stats=True, sort_by="cumulative", limit=40
        ):
