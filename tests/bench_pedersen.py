...
def load_test_data():
    ...
    vector_path = (
        ...
        / "vectors"
        / "ark-vrf"
        / "bandersnatch_ed_sha512_ell2_pedersen.json"
    )
...
def benchmark_pedersen_vrf(warmup_iters: int = 5, bench_iters: int = 100):
    ...
    # Get public key
    PedersenVRF[Bandersnatch].get_public_key(s_k)  # type: ignore
    ...
    for _ in range(warmup_iters):
        proof = PedersenVRF[Bandersnatch].prove(alpha, s_k, ad)  # type: ignore
