    ...
    for i, file in enumerate(os.listdir(data_dir)):
        ...
        with open(os.path.join(data_dir, file), "r") as f:
            ...
            for i, vector in enumerate(data):
                ...
                vrf = IETF_VRF(Secp256k1_SW_Curve, Secp256k1Point)
                ...
                public_key=Secp256k1Point.string_to_point(vrf.get_public_key(vector['sk']))
                verified=vrf.verify(public_key, Secp256k1Point.string_to_point(input_point), vector["ad"], proof)
