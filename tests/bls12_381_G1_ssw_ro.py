from dot_ring.curve.specs.bls12_381_G1 import (BLS12_381_G1Curve, BLS12_381_G1Point)


def test_sswu_hash2_curve():
    import json
    json_path = "/home/siva/PycharmProjects/DT/dot_ring/tests/vectors/bls12_381_G1_ro.json"
    # Load JSON
