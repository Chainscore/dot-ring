...
class TestTranscriptAdditional:
    """Additional tests for FiatShamirTranscript class."""

    def test_transcript_init(self):
        """Test FiatShamirTranscript initialization."""
        transcript = FiatShamirTranscript(S_PRIME, b"test_transcript")
        assert transcript is not None

    def test_transcript_label(self):
        """Test adding label to transcript."""
        transcript = FiatShamirTranscript(S_PRIME, b"test")
